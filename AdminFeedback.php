...
<div class="float-right icon">
  ...
  <a href="AdminUserDetails.php" style="display:flex;"><img src="<?php echo $photo ?>" style="height:9vh; width:9vh; object-fit: cover;  border-radius: 50px; margin-left:14rem; cursor:pointer"></a></div>
...
<div class="container">
  <div class="row ">
    <?php
    $sql="SELECT * FROM feedback WHERE Feedback IS NOT NULL AND Feedback <>''";
    $result=mysqli_query($conn,$sql);
    if(mysqli_num_rows($result)>0){
      while($row=mysqli_fetch_assoc($result)){
        ...
        if($User_Type=="Buyer"){
          $sql1="SELECT * FROM buyerdetails WHERE Email='$Email'";
          ...
          if(mysqli_num_rows($result1)>0){
            ...
            $Name="User";
            $photo="uploads/other.jpg";
          }
        }
        elseif($User_Type=="Seller"){
          $sql1="SELECT * FROM sellerdetails WHERE Email='$Email'";
          $result1=mysqli_query($conn,$sql1);
          if(mysqli_num_rows($result1)>0){
            while($row1=mysqli_fetch_assoc($result1)){
              $Name=$row1['Name'];
    ...
    ?>
    <div class="col-8">
    <img src="<?php echo $photo ?>" class="rounded-circle" height="50px" width="50px"alt="">
<span style="margin:1rem; font-weight:bolder;font-size:1.5rem"> <?php echo $Name ?></span>

<span style="color:rgb(255,255,255,0.500); font-weight:bolder;font-size:1rem"><?php echo $Date ?></span><br>
<span style="color:rgb(255,255,255,0.500); font-weight:bolder;font-size:1rem">  <?php echo $User_Type ?></span>
<p  id="scroll" style="background:white;height:7rem;width:50rem;color:rgb(0,0,0,0.600);padding:0.9rem 0.5rem 0.5rem 2rem;font-size:16px; font-weight:bolder;border-radius:20px;margin-top:0.5rem;overflow:auto;   border-bottom-left-radius: 120px;
    border-top-left-radius: 120px;

    border-bottom-right-radius: 120px;">  <?php echo $Feedback ?></p>
